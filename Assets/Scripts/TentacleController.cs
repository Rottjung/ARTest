...
namespace ARReveal
{
    ...
    public class TentacleController : MonoBehaviour
    {
        ...
        /// ARShareController's WarningPopup) can ask "is the viewer currently
        /// close enough for THIS tentacle to attack" without duplicating the
        /// distance math or depending on ReachByDistance being enabled - a
        /// tentacle with SnapAtCameraOnSettle only (no repeating
        /// ReachByDistance attacks) still has a perfectly meaningful "attack
        /// range" via its own SnapDistance. Re-added (was briefly removed
        /// along with the original Distance Alert screen it existed for -
        /// see git history around "Remove the Distance Alert" - now reused
        /// for the same purpose by the newer WarningPopup).
        /// </summary>
